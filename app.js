...
const addTheme = (
  ...
  xBox.style.backgroundColor =
    boxBackgrounColor || colorPalettes[paletteIndex][xLetterIndex].fill;
  ...
  allBoxes.forEach(
    (box, i) =>
      (box.style.backgroundColor =
        boxBackgrounColor || colorPalettes[paletteIndex][i].fill)
  );
...
const moveSlider = () => {
  ...
  if (sliderValue == 0) {
    // bodyBackgroundColor,strokeWidth,svgFill,opacity,lineColor,borderRadius,boxBackgrounColor,pillBackgroundColor
    addTheme(
      "white",
      "12px",
      null,
